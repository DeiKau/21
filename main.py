...
# Function to draw scores for player and dealer on screen
...
# Function to draw cards visually onto screen
...
# Function to draw game conditions and buttons
...
# Function to check endgame conditions
